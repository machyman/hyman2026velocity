...
Companion code, data and manuscript source. Manuscript version **v1_32_0**.
...
manuscript/     the compiled paper
  hyman2026velocity_v1_32_0.pdf     manuscript, 20 pages
...
maintained by hand, so that eight near-identical files cannot drift apart.
...
5. Commit directly to `main` with a message naming the manuscript version, for
   example `v1_32_0: one-step test table, scope corrections`.
