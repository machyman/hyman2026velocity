#!/usr/bin/env python3
"""
kac_phasef_v2_0_0.py -- RECONSTRUCTION. DISCLOSED DEVELOPMENT WORK.
...
def main():
    ...
    with open("phasef_part1.csv", "w") as fh:
        fh.write("scheme,mean_v4,bias,variance,mse,var_ratio_vs_MC\n")
        for r in rows:
    ...
    with open("phasef_part2.csv", "w") as fh:
        fh.write("w,c_over_cbar,bias_v4,mse_v4,bias_absv,var_absv,mse_absv\n")
        for r in rows2:
            fh.write(",".join(str(x) for x in r) + "\n")
